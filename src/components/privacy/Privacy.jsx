...
const Privacy = () => {
  ...
  return (
    <div className="h-auto flex flex-col bg-[#e9ecef] m-[2rem] p-[4rem] gap-4 rounded-lg">
      ...
      <h1 className="font-['rubik_doodle_shadow'] font-bold text-5xl text-center my-[3rem]">
        Interpretation and Definitions
      </h1>
      <div className="text-lg bg-white rounded-md p-[2rem]">
        <h1 className="font-bold text-3xl  font-['rubik_doodle_shadow']">Interpretation :</h1>
        <p className="text-lg p-[1rem]">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The
          following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h1 className="font-bold text-3xl  font-['rubik_doodle_shadow']">Definitions :</h1>
        <p className="text-lg p-[1rem]">For the purposes of this Privacy Policy:</p>
      ...
      <div className="text-lg bg-white rounded-md p-[2rem]">
        <h1 className="font-bold text-3xl  font-['rubik_doodle_shadow']">Types of Data Collected :</h1>
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">Personal Data :</h1>
        ...
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">Usage Data :</h1>
        <p className="text-base mx-[2rem]">Usage Data is collected automatically when using the Service</p>
        <br />
        <p className="text-base mx-[2rem]">
        ...
        <h1 className="font-bold text-xl  mx-[2rem] font-['rubik_doodle_shadow'] py-[1rem]">
          Cookies or Browser Cookies
        </h1>
        <p className=" mx-[3rem] text-base">
        ...
        <h1 className="font-bold text-xl  mx-[2rem] font-['rubik_doodle_shadow'] py-[1rem]">Web Beacons</h1>
        <p className=" mx-[3rem] text-base">
        ...
        <p className="text-lg mx-[1.5rem] mt-[1rem]">
        ...
        <li className="mx-[3rem] mt-[1rem] font-bold">
        ...
        <p className="text-lg mx-[1.5rem] ">The Company may use Personal Data for the following purposes:</p>
        {useData.map((item, index) => (
          <li key={index} className="px-[2.5rem] text-base">
            {item}
          </li>
        ))}
        <p className="text-lg mx-[1.5rem] mt-[1rem]">
        ...
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">Children's Privacy</h1>
        <p className="mx-[1.5rem] font-normal text-base">
        ...
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">Contact Us</h1>
        <p className="mx-[1.5rem] font-normal text-base">
          If you have any questions about this Privacy Policy, You can contact us:
        </p>
        <li className=" mx-[3rem] text-base ">By phone number: +18234555</li>
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">Cancellation Policy</h1>
        <li className=" mx-[3rem] text-base ">
          {" "}
          The contract will be not effective between the service provider Travel Magnet Infotech Private Limited (TMIS))
          and the client until received the full amount of payment from client.
        </li>
        ...
        <li className=" mx-[5rem] text-base ">
          To cancel the contract by reason prior to the date of service provide and if does so, its liability shall be
          limited to refunding amount received from client without inclusion of any percentage of interest.
        </li>
        <li className=" mx-[5rem] text-base ">
        ...
        <li className=" mx-[3rem] text-base ">
          ...
          other service provider agency apart from services officially confirmed by TMIS also not be responsible for the
          sudden situations if arise within the service providing period by the agency TMIS as damage , lost of luggage
          or any valuable goods, in the case of caused by the act or default of the management or employee of any
          hotelier, airline, surface transport, who are the agency’s independent service associates. <br />
          The TMIS also not liable for situation arising out side of normal selection and inspection process, or acts of
          Government authority, war, civil or political disturbances, strike, natural calamities - as landslide, flood,
          earthquake, and others of it’s kind. As a result of any of the causes delay of days out of contract period and
          changes of itinerary the extra expense will be bear by the client.
        </li>
        <li className=" mx-[3rem] text-base ">
          The agency TMIS shall in no any circumstances whatsoever be liable to the client or persons traveling with the
          agency in the contract period of service provide for :-
        </li>
        <li className=" mx-[5rem] text-base ">
          Any death, physical injury, sickness, accidental case, any illegal or immoral activity, any penalty by caused
          of activity’s against civic rule, any damage or lost of luggage or valuable goods,
        </li>
        <li className=" mx-[3rem] text-base ">
          The amount quoted for the particular services has been calculated as per the fuel and related cost prevailing
          at the time of submission of the rate quotation. <br />
          The TMIS reserves the right to amend the quoted rate in case of changes in any tax or surcharges structure,
          increase of fuel cost, and any of cost increase beyond control of the company. On that situation the service
          provider agency We will inform in advance to the client or related person for additional payment amount to be
          paid before start of service.
        </li>
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">BOOKING PROCEDURE :</h1>
        ...
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">Refund Policy</h1>
        <p className="mx-[1.5rem] font-normal text-base">
          If the tour or any part thereof cannot be conducted due to Force Majeure or Vis Majeure, the Company shall not
          be responsible to give any refund to you. <br />
          If the tour or any part thereof cannot be conducted due to Force Majeure or Vis Majeure, the Company shall not
          be responsible to give any refund to you. However, at its sole discretion, the Company gives the refund based
          on various factors like the number of participants, the cancellation policies of suppliers like hoteliers,
          coach operators, etc. the decision of the Company on the quantum of refund shall be final.
          <br />
          It would take at least minimum of 15 to 45 days to process the refund (if due). <br />
          It is clearly understood that there shall be no refund whatsoever if the Client does not or cannot utilize any
          of the services like hotels, sightseeing, rides, cruises, meals, entrance fees, optional tours etc., due to
          ...
          their credit card account at the discretion of the company. It would at least take 45 days to process refunds.{" "}
          <br />
          ...
          account if paid by bank transfer, net banking mode / credit /debit card – reversal to their respective credit
          card account will be done. This process will take 15 to 45 days to reflect in their account. <br />
          Clients have option to keep their refund money in our account and collect credit certificate and utilise the
          same with 24 months.
        </p>
        <h1 className="font-bold text-2xl  mx-[1rem] font-['rubik_doodle_shadow'] py-[1rem]">CONDITIONS OF TRAVEL :</h1>
